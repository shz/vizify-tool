...
var AbstractNode = (function() {
  ...
  AbstractNode.prototype.generateJsonConversionExpression = function(fieldname) {
...
var Struct = (function() {
      ...
      Object.keys(this.properties)
        .map(function(prop) {
          return [
            ...
            "  if !json__" + prop + ".isNull() { instance." + prop + " = " + this.properties[prop].generateJsonConversionExpression(prop) + " }"
          ].join("\n");
        }.bind(this))
        .join("\n"),
      "  return instance",
  ...
  Struct.prototype.generateJsonConversionExpression = function(fieldname) {
    return this.makerFunctionName() + '(json.get("' + fieldname + '"))';
  };
...
var List = (function() {
  ...
  List.prototype.generateJsonConversionExpression = function(fieldname) {
    return this.makerFunctionName() + '(json.get("' + fieldname + '").asList())';
  };
